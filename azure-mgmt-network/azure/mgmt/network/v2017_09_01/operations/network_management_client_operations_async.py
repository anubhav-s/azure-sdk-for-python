...
from .. import models
import uuid
from .network_management_client_operations import NetworkManagementClientOperationsMixin as _NetworkManagementClientOperationsMixin


class NetworkManagementClientOperationsMixin(_NetworkManagementClientOperationsMixin):

    async def check_dns_name_availability_async(
        ...
        # Construct URL
        url = self.check_dns_name_availability_async.metadata['url']
        ...
        return deserialized
    check_dns_name_availability_async.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/locations/{location}/CheckDnsNameAvailability'}

...
from .. import models
from .load_balancer_probes_operations import LoadBalancerProbesOperations as _LoadBalancerProbesOperations


class LoadBalancerProbesOperations(_LoadBalancerProbesOperations):
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/probes/{probeName}'}

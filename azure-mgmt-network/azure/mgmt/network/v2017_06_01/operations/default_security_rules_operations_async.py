...
from .. import models
from .default_security_rules_operations import DefaultSecurityRulesOperations as _DefaultSecurityRulesOperations


class DefaultSecurityRulesOperations(_DefaultSecurityRulesOperations):
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkSecurityGroups/{networkSecurityGroupName}/defaultSecurityRules/{defaultSecurityRuleName}'}

...
from .. import models
from .load_balancer_backend_address_pools_operations import LoadBalancerBackendAddressPoolsOperations as _LoadBalancerBackendAddressPoolsOperations


class LoadBalancerBackendAddressPoolsOperations(_LoadBalancerBackendAddressPoolsOperations):
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/backendAddressPools/{backendAddressPoolName}'}

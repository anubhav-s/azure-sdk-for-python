...
from .. import models
from .load_balancer_load_balancing_rules_operations import LoadBalancerLoadBalancingRulesOperations as _LoadBalancerLoadBalancingRulesOperations


class LoadBalancerLoadBalancingRulesOperations(_LoadBalancerLoadBalancingRulesOperations):
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/loadBalancingRules/{loadBalancingRuleName}'}

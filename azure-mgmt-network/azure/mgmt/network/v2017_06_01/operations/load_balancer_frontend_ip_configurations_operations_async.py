...
from .. import models
from .load_balancer_frontend_ip_configurations_operations import LoadBalancerFrontendIPConfigurationsOperations as _LoadBalancerFrontendIPConfigurationsOperations


class LoadBalancerFrontendIPConfigurationsOperations(_LoadBalancerFrontendIPConfigurationsOperations):
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/loadBalancers/{loadBalancerName}/frontendIPConfigurations/{frontendIPConfigurationName}'}

...
from .. import models
from .bgp_service_communities_operations import BgpServiceCommunitiesOperations as _BgpServiceCommunitiesOperations


class BgpServiceCommunitiesOperations(_BgpServiceCommunitiesOperations):

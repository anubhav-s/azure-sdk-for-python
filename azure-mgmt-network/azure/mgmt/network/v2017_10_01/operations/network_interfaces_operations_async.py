...
from .. import models
from .network_interfaces_operations import NetworkInterfacesOperations as _NetworkInterfacesOperations


class NetworkInterfacesOperations(_NetworkInterfacesOperations):
    ...
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}'}
    ...
    async def create_or_update_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}'}
    ...
    async def update_tags_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_tags_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}'}
    ...
    async def _get_effective_route_table_initial_async(
            self, resource_group_name, network_interface_name, *, custom_headers=None, raw=False, **operation_config):
        api_version = "2017-10-01"

        # Construct URL
        url = self.get_effective_route_table_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'networkInterfaceName': self._serialize.url("network_interface_name", network_interface_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
    ...
    async def get_effective_route_table_async(
            self, resource_group_name, network_interface_name, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = await self._get_effective_route_table_initial_async(
            resource_group_name=resource_group_name,
            network_interface_name=network_interface_name,
            custom_headers=custom_headers,
            raw=True,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    get_effective_route_table_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/effectiveRouteTable'}


    async def _list_effective_network_security_groups_initial_async(
            self, resource_group_name, network_interface_name, *, custom_headers=None, raw=False, **operation_config):
        api_version = "2017-10-01"

        # Construct URL
        url = self.list_effective_network_security_groups_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'networkInterfaceName': self._serialize.url("network_interface_name", network_interface_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
    ...
    async def list_effective_network_security_groups_async(
            self, resource_group_name, network_interface_name, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = await self._list_effective_network_security_groups_initial_async(
            resource_group_name=resource_group_name,
            network_interface_name=network_interface_name,
            custom_headers=custom_headers,
            raw=True,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    list_effective_network_security_groups_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/effectiveNetworkSecurityGroups'}
    ...
    async def get_virtual_machine_scale_set_network_interface_async(
        ...
        # Construct URL
        url = self.get_virtual_machine_scale_set_network_interface_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'virtualMachineScaleSetName': self._serialize.url("virtual_machine_scale_set_name", virtual_machine_scale_set_name, 'str'),
            'virtualmachineIndex': self._serialize.url("virtualmachine_index", virtualmachine_index, 'str'),
        ...
        return deserialized
    get_virtual_machine_scale_set_network_interface_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/microsoft.Compute/virtualMachineScaleSets/{virtualMachineScaleSetName}/virtualMachines/{virtualmachineIndex}/networkInterfaces/{networkInterfaceName}'}
    ...
    async def get_virtual_machine_scale_set_ip_configuration_async(
        ...
        # Construct URL
        url = self.get_virtual_machine_scale_set_ip_configuration_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'virtualMachineScaleSetName': self._serialize.url("virtual_machine_scale_set_name", virtual_machine_scale_set_name, 'str'),
            'virtualmachineIndex': self._serialize.url("virtualmachine_index", virtualmachine_index, 'str'),

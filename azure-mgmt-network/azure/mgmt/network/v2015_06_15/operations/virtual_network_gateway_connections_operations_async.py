...
class VirtualNetworkGatewayConnectionsOperations(_VirtualNetworkGatewayConnectionsOperations):
    ...
    async def get_shared_key_async(
        ...
        return deserialized
    get_shared_key_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/connections/{connectionSharedKeyName}/sharedkey'}

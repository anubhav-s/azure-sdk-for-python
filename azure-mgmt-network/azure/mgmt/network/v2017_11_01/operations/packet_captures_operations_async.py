...
from .. import models
from .packet_captures_operations import PacketCapturesOperations as _PacketCapturesOperations


class PacketCapturesOperations(_PacketCapturesOperations):
    ...
    async def create_async(
        ...
        :rtype: ~~azure.mgmt.network.v2017_11_01.models.PacketCaptureResult or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.PacketCaptureResult]
    ...
    create_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/packetCaptures/{packetCaptureName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/packetCaptures/{packetCaptureName}'}
    ...
    async def delete_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/packetCaptures/{packetCaptureName}'}
    ...
    async def stop_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    stop_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/packetCaptures/{packetCaptureName}/stop'}


    async def _get_status_initial_async(
            self, resource_group_name, network_watcher_name, packet_capture_name, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.get_status_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'networkWatcherName': self._serialize.url("network_watcher_name", network_watcher_name, 'str'),
            'packetCaptureName': self._serialize.url("packet_capture_name", packet_capture_name, 'str'),
    ...
    async def get_status_async(
        ...
        :rtype:
         ~~azure.mgmt.network.v2017_11_01.models.PacketCaptureQueryStatusResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.PacketCaptureQueryStatusResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = await self._get_status_initial_async(
            resource_group_name=resource_group_name,
            network_watcher_name=network_watcher_name,
            packet_capture_name=packet_capture_name,
            custom_headers=custom_headers,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    get_status_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkWatchers/{networkWatcherName}/packetCaptures/{packetCaptureName}/queryStatus'}

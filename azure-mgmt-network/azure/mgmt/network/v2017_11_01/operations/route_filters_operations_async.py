...
from .. import models
from .route_filters_operations import RouteFiltersOperations as _RouteFiltersOperations


class RouteFiltersOperations(_RouteFiltersOperations):
    ...
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}'}
    ...
    async def create_or_update_async(
        ...
        :return: An instance of RouteFilter or ClientRawResponse<RouteFilter>
         if raw==True
        :rtype: ~~azure.mgmt.network.v2017_11_01.models.RouteFilter or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2017_11_01.models.RouteFilter]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}'}
    ...
    async def update_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/routeFilters/{routeFilterName}'}

...
from .. import models
from .express_route_circuits_operations import ExpressRouteCircuitsOperations as _ExpressRouteCircuitsOperations


class ExpressRouteCircuitsOperations(_ExpressRouteCircuitsOperations):
    ...
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}'}
    ...
    async def create_or_update_async(
        ...
        :rtype: ~~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuit or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuit]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}'}
    ...
    async def update_tags_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_tags_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}'}


    async def _list_arp_table_initial_async(
            self, resource_group_name, circuit_name, peering_name, device_path, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.list_arp_table_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'circuitName': self._serialize.url("circuit_name", circuit_name, 'str'),
    ...
    async def list_arp_table_async(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuitsArpTableListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuitsArpTableListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = await self._list_arp_table_initial_async(
            resource_group_name=resource_group_name,
            circuit_name=circuit_name,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    list_arp_table_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/arpTables/{devicePath}'}


    async def _list_routes_table_initial_async(
            self, resource_group_name, circuit_name, peering_name, device_path, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.list_routes_table_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'circuitName': self._serialize.url("circuit_name", circuit_name, 'str'),
            'peeringName': self._serialize.url("peering_name", peering_name, 'str'),
    ...
    async def list_routes_table_async(
            self, resource_group_name, circuit_name, peering_name, device_path, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :return: An instance of ExpressRouteCircuitsRoutesTableListResult or
         ...
         raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuitsRoutesTableListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuitsRoutesTableListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = await self._list_routes_table_initial_async(
            resource_group_name=resource_group_name,
            circuit_name=circuit_name,
            peering_name=peering_name,
            device_path=device_path,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    list_routes_table_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/routeTables/{devicePath}'}


    async def _list_routes_table_summary_initial_async(
            self, resource_group_name, circuit_name, peering_name, device_path, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.list_routes_table_summary_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'circuitName': self._serialize.url("circuit_name", circuit_name, 'str'),
            'peeringName': self._serialize.url("peering_name", peering_name, 'str'),
    ...
    async def list_routes_table_summary_async(
            self, resource_group_name, circuit_name, peering_name, device_path, *, custom_headers=None, raw=False, polling=True, **operation_config):
        ...
        :return: An instance of
         ...
         raw==True
        :rtype:
         ~~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuitsRoutesTableSummaryListResult
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.ExpressRouteCircuitsRoutesTableSummaryListResult]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = await self._list_routes_table_summary_initial_async(
            resource_group_name=resource_group_name,
            circuit_name=circuit_name,
            peering_name=peering_name,
            device_path=device_path,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    list_routes_table_summary_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/routeTablesSummary/{devicePath}'}
    ...
    async def get_stats_async(
        ...
        """
        # Construct URL
        url = self.get_stats_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'circuitName': self._serialize.url("circuit_name", circuit_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        ...
        return deserialized
    get_stats_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/stats'}

    async def get_peering_stats_async(
        ...
        """
        # Construct URL
        url = self.get_peering_stats_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'circuitName': self._serialize.url("circuit_name", circuit_name, 'str'),
            'peeringName': self._serialize.url("peering_name", peering_name, 'str'),
        ...
        return deserialized
    get_peering_stats_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/peerings/{peeringName}/stats'}

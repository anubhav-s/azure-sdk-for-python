...
from .. import models
from .application_gateways_operations import ApplicationGatewaysOperations as _ApplicationGatewaysOperations


class ApplicationGatewaysOperations(_ApplicationGatewaysOperations):
    ...
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}'}
    ...
    async def create_or_update_async(
        ...
        :rtype: ~~azure.mgmt.network.v2018_01_01.models.ApplicationGateway or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.ApplicationGateway]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}'}
    ...
    async def update_tags_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_tags_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}'}
    ...
    async def start_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    start_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/start'}
    ...
    async def stop_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    stop_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/stop'}


    async def _backend_health_initial_async(
            self, resource_group_name, application_gateway_name, expand=None, *, custom_headers=None, raw=False, **operation_config):
        # Construct URL
        url = self.backend_health_async.metadata['url']
        path_format_arguments = {
            'resourceGroupName': self._serialize.url("resource_group_name", resource_group_name, 'str'),
            'applicationGatewayName': self._serialize.url("application_gateway_name", application_gateway_name, 'str'),
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
    ...
    async def backend_health_async(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_01_01.models.ApplicationGatewayBackendHealth
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.ApplicationGatewayBackendHealth]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        raw_result = await self._backend_health_initial_async(
            resource_group_name=resource_group_name,
            application_gateway_name=application_gateway_name,
            expand=expand,
            custom_headers=custom_headers,
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    backend_health_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationGateways/{applicationGatewayName}/backendhealth'}

    async def list_available_waf_rule_sets_async(
            self, *, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.list_available_waf_rule_sets_async.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    list_available_waf_rule_sets_async.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableWafRuleSets'}

    async def list_available_ssl_options_async(
            self, *, custom_headers=None, raw=False, **operation_config):
        ...
        """
        # Construct URL
        url = self.list_available_ssl_options_async.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str')
        }
        url = self._client.format_url(url, **path_format_arguments)
        ...
        return deserialized
    list_available_ssl_options_async.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableSslOptions/default'}
    ...
    async def get_ssl_predefined_policy_async(
        ...
        """
        # Construct URL
        url = self.get_ssl_predefined_policy_async.metadata['url']
        path_format_arguments = {
            'subscriptionId': self._serialize.url("self.config.subscription_id", self.config.subscription_id, 'str'),
        ...
        return deserialized
    get_ssl_predefined_policy_async.metadata = {'url': '/subscriptions/{subscriptionId}/providers/Microsoft.Network/applicationGatewayAvailableSslOptions/default/predefinedPolicies/{predefinedPolicyName}'}

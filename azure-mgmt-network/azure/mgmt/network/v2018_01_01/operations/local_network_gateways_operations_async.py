...
from .. import models
from .local_network_gateways_operations import LocalNetworkGatewaysOperations as _LocalNetworkGatewaysOperations


class LocalNetworkGatewaysOperations(_LocalNetworkGatewaysOperations):
    ...
    async def create_or_update_async(
        ...
        :rtype: ~~azure.mgmt.network.v2018_01_01.models.LocalNetworkGateway or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.LocalNetworkGateway]
    ...
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}
    ...
    async def delete_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}
    ...
    async def update_tags_async(
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    update_tags_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/localNetworkGateways/{localNetworkGatewayName}'}

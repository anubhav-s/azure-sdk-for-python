...
from .. import models
from .application_security_groups_operations import ApplicationSecurityGroupsOperations as _ApplicationSecurityGroupsOperations


class ApplicationSecurityGroupsOperations(_ApplicationSecurityGroupsOperations):
    ...
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationSecurityGroups/{applicationSecurityGroupName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationSecurityGroups/{applicationSecurityGroupName}'}
    ...
    async def create_or_update_async(
        ...
        :rtype:
         ~~azure.mgmt.network.v2018_01_01.models.ApplicationSecurityGroup or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2018_01_01.models.ApplicationSecurityGroup]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/applicationSecurityGroups/{applicationSecurityGroupName}'}

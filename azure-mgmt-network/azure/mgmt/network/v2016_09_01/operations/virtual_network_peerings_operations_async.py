...
from .. import models
from .virtual_network_peerings_operations import VirtualNetworkPeeringsOperations as _VirtualNetworkPeeringsOperations


class VirtualNetworkPeeringsOperations(_VirtualNetworkPeeringsOperations):
    ...
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}'}
    ...
    async def create_or_update_async(
        ...
        :rtype: ~~azure.mgmt.network.v2016_09_01.models.VirtualNetworkPeering
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_09_01.models.VirtualNetworkPeering]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/virtualNetworks/{virtualNetworkName}/virtualNetworkPeerings/{virtualNetworkPeeringName}'}

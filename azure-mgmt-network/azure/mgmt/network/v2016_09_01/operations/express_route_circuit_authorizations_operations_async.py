...
from .. import models
from .express_route_circuit_authorizations_operations import ExpressRouteCircuitAuthorizationsOperations as _ExpressRouteCircuitAuthorizationsOperations


class ExpressRouteCircuitAuthorizationsOperations(_ExpressRouteCircuitAuthorizationsOperations):
    ...
    delete_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/authorizations/{authorizationName}'}
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/authorizations/{authorizationName}'}
    ...
    async def create_or_update_async(
        ...
        :rtype:
         ~~azure.mgmt.network.v2016_09_01.models.ExpressRouteCircuitAuthorization
         or
         ~msrest.pipeline.ClientRawResponse[~azure.mgmt.network.v2016_09_01.models.ExpressRouteCircuitAuthorization]
        :raises: :class:`CloudError<msrestazure.azure_exceptions.CloudError>`
        """
        ...
        return await async_poller(self._client, raw_result, get_long_running_output, polling_method)
    create_or_update_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/expressRouteCircuits/{circuitName}/authorizations/{authorizationName}'}

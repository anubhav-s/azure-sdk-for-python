...
from .. import models
from .network_interface_ip_configurations_operations import NetworkInterfaceIPConfigurationsOperations as _NetworkInterfaceIPConfigurationsOperations


class NetworkInterfaceIPConfigurationsOperations(_NetworkInterfaceIPConfigurationsOperations):
    ...
    async def get_async(
        ...
        return deserialized
    get_async.metadata = {'url': '/subscriptions/{subscriptionId}/resourceGroups/{resourceGroupName}/providers/Microsoft.Network/networkInterfaces/{networkInterfaceName}/ipConfigurations/{ipConfigurationName}'}
